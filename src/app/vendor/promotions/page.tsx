    ...
    <SiteLayout>
      <div className="container py-8">
        <div className="mb-8">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">Promotions & Discounts</h1>
            <p className="text-muted-foreground text-sm sm:text-base">Manage coupons and sales</p>
          </div>
        </div>
